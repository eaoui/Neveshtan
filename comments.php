    ...
    comment_form(
        array(
            'fields' => array(
                ...
                'cookies' => '<div><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" type="checkbox" value="yes"><lable for="wp-comment-cookies-consent">' . __('Remember me', 'neveshtan') . '</lable></div>'
            ),
